...
jpeg(file = '~/Team_1/results/dataplots.jpeg')
plot(x20, y20, pch = 20, cex = .6, col='red',  xlab='wavelength', ylab='Radiation(W/m^2) ', main = "Ref_Factor vs Wavelength")
par(new= TRUE)
plot(x48, y48, pch = 20, cex = .6, col = 'green')
par(new= TRUE)
plot(x75, y75, pch = 20, cex = .6, col = 'cyan')
par(new= TRUE)
plot(x95, y95, pch = 20, cex = .6, 'blue')
par(new= TRUE)
plot(x99, y99, pch = 20, cex = .6, col = 'black')
...
#par(mfrow=c(1,2))
jpeg(file = '~/Team_1/results/fittmean_48.jpeg')
...
dev.off()
#par(new=TRUE)
jpeg(file = '~/Team_1/results/fittmean_99.jpeg')
